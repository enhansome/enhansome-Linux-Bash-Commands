...
[cheat.sh](https://github.com/chubin/cheat.sh) ⭐ 41,628 | 🐛 148 | 🌐 Python | 📅 2025-12-23<br>
...
| UNIX/Linux commands     | [tldr-pages/tldr](https://github.com/tldr-pages/tldr) ⭐ 63,391 \| 🐛 320 \| 🌐 Markdown \| 📅 2026-08-12                               | ![](https://img.shields.io/github/contributors-anon/tldr-pages/tldr?label=%F0%9F%91%A5\&labelColor=white)                | ![](https://img.shields.io/github/stars/tldr-pages/tldr?label=%E2%AD%90\&labelColor=white)                | Dec 8, 2013   |
...
|               [shell-scripting-tutorial](https://github.com/techarkit/shell-scripting-tutorial) ⭐ 690 \| 🐛 4 \| 🌐 Shell \| 📅 2026-01-27              | A complete beginner's guide to learning shell scripting from scratch, with videos, practice scenarios, and project ideas.                            |
...
| [Shell Cheat Sheet](https://github.com/LeCoupa/awesome-cheatsheets/blob/master/languages/shell.sh) ⭐ 46,339 \| 🐛 136 \| 🌐 JavaScript \| 📅 2026-04-12 | A detailed and organized shell scripting cheat sheet for quick reference.                                                                            |
...
|                    [DevOps Bash Tools](https://github.com/HariSekhon/DevOps-Bash-tools) ⭐ 8,374 \| 🐛 9 \| 🌐 Shell \| 📅 2026-08-05                    | A comprehensive collection of 1000+ DevOps bash scripts for AWS, GCP, Kubernetes, Docker, CI/CD, databases, and more.                                |
...
|                              [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,435 \| 🐛 184 \| 📅 2025-08-28                              | A list of awesome shell tools and resources, including libraries and scripts for enhancing the command-line experience.                              |
...
|                             [cli-apps](https://github.com/toolleeo/cli-apps) ⭐ 2,581 \| 🐛 142 \| 🌐 Python \| 📅 2026-07-29                            | A curated list of (mainly) CLI/TUI applications with source data organized into CSV files.                                                           |
...
|                              [awesome-cli](https://github.com/umutphp/awesome-cli) ⭐ 794 \| 🐛 2 \| 🌐 Go \| 📅 2025-10-08                              | A simple command line tool to give you a fancy command line interface to dive into Awesome lists.                                                    |
...
|                            [shell\_gpt](https://github.com/TheR1D/shell_gpt) ⭐ 12,234 \| 🐛 117 \| 🌐 Python \| 📅 2026-07-02                           | A command-line productivity tool powered by AI large language models like GPT-4.                                                                     |
|                            [aider](https://github.com/paul-gauthier/aider) ⭐ 48,158 \| 🐛 1,794 \| 🌐 Python \| 📅 2026-05-22                           | AI pair programming in your terminal.                                                                                                                |
|                               [plandex](https://github.com/plandex-ai/plandex) ⭐ 15,580 \| 🐛 60 \| 🌐 Go \| 📅 2025-10-03                              | AI driven development in your terminal. Designed for large, real-world tasks.                                                                        |
|                               [warp](https://github.com/warpdotdev/Warp) ⭐ 64,176 \| 🐛 4,931 \| 🌐 Rust \| 📅 2026-08-13                               | Warp is a modern, Rust-based terminal with AI built in so you and your team can build great software, faster.                                        |
...
|                     [awesome-console-services](https://github.com/chubin/awesome-console-services) ⭐ 6,492 \| 🐛 22 \| 📅 2026-02-01                    | A curated list of awesome console services (reachable via HTTP, HTTPS and other network protocols).                                                  |
