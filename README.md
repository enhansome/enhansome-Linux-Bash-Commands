...
| UNIX/Linux commands     | [tldr-pages/tldr](https://github.com/tldr-pages/tldr) ⭐ 63,497 \| 🐛 289 \| 🌐 Markdown \| 📅 2026-08-27                               | ![](https://img.shields.io/github/contributors-anon/tldr-pages/tldr?label=%F0%9F%91%A5\&labelColor=white)                | ![](https://img.shields.io/github/stars/tldr-pages/tldr?label=%E2%AD%90\&labelColor=white)                | Dec 8, 2013   |
...
|       [introduction-to-bash-scripting](https://github.com/bobbyiliev/introduction-to-bash-scripting) ⭐ 6,318 \| 🐛 10 \| 🌐 HTML \| 📅 2026-02-11       | Free Introduction to Bash Scripting eBook.                                                                                                           |
...
| [Shell Cheat Sheet](https://github.com/LeCoupa/awesome-cheatsheets/blob/master/languages/shell.sh) ⭐ 46,405 \| 🐛 137 \| 🌐 JavaScript \| 📅 2026-04-12 | A detailed and organized shell scripting cheat sheet for quick reference.                                                                            |
...
|                              [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,514 \| 🐛 184 \| 📅 2025-08-28                              | A list of awesome shell tools and resources, including libraries and scripts for enhancing the command-line experience.                              |
...
|                             [cli-apps](https://github.com/toolleeo/cli-apps) ⭐ 2,597 \| 🐛 170 \| 🌐 Python \| 📅 2026-07-29                            | A curated list of (mainly) CLI/TUI applications with source data organized into CSV files.                                                           |
...
|                               [warp](https://github.com/warpdotdev/Warp) ⭐ 64,553 \| 🐛 5,107 \| 🌐 Rust \| 📅 2026-08-27                               | Warp is a modern, Rust-based terminal with AI built in so you and your team can build great software, faster.                                        |
...
|                     [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) ⭐ 13,091 \| 🐛 149 \| 🌐 Shell \| 📅 2024-07-26                    | A curated list of Terminal frameworks, plugins, and resources for CLI lovers.                                                                        |
