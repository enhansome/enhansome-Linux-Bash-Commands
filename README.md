...
[cheat.sh](https://github.com/chubin/cheat.sh) ⭐ 41,696 | 🐛 148 | 🌐 Python | 📅 2025-12-23<br>
...
| UNIX/Linux commands     | [tldr-pages/tldr](https://github.com/tldr-pages/tldr) ⭐ 63,515 \| 🐛 303 \| 🌐 Markdown \| 📅 2026-08-29                               | ![](https://img.shields.io/github/contributors-anon/tldr-pages/tldr?label=%F0%9F%91%A5\&labelColor=white)                | ![](https://img.shields.io/github/stars/tldr-pages/tldr?label=%E2%AD%90\&labelColor=white)                | Dec 8, 2013   |
...
### Offline usage [install](https://github.com/chubin/cheat.sh#installation) ⭐ 41,696 | 🐛 148 | 🌐 Python | 📅 2025-12-23 cheat script manually<br>
...
|       [introduction-to-bash-scripting](https://github.com/bobbyiliev/introduction-to-bash-scripting) ⭐ 6,322 \| 🐛 10 \| 🌐 HTML \| 📅 2026-02-11       | Free Introduction to Bash Scripting eBook.                                                                                                           |
...
| [Shell Cheat Sheet](https://github.com/LeCoupa/awesome-cheatsheets/blob/master/languages/shell.sh) ⭐ 46,405 \| 🐛 136 \| 🌐 JavaScript \| 📅 2026-04-12 | A detailed and organized shell scripting cheat sheet for quick reference.                                                                            |
...
|                    [DevOps Bash Tools](https://github.com/HariSekhon/DevOps-Bash-tools) ⭐ 8,390 \| 🐛 8 \| 🌐 Shell \| 📅 2026-08-24                    | A comprehensive collection of 1000+ DevOps bash scripts for AWS, GCP, Kubernetes, Docker, CI/CD, databases, and more.                                |
...
|                              [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,525 \| 🐛 185 \| 📅 2025-08-28                              | A list of awesome shell tools and resources, including libraries and scripts for enhancing the command-line experience.                              |
...
|                             [cli-apps](https://github.com/toolleeo/cli-apps) ⭐ 2,601 \| 🐛 170 \| 🌐 Python \| 📅 2026-07-29                            | A curated list of (mainly) CLI/TUI applications with source data organized into CSV files.                                                           |
...
|                                [awesome-tuis](https://github.com/rothgar/awesome-tuis) ⭐ 20,386 \| 🐛 95 \| 📅 2026-08-11                               | List of projects that provide terminal user interfaces.                                                                                              |
...
|                            [shell\_gpt](https://github.com/TheR1D/shell_gpt) ⭐ 12,261 \| 🐛 120 \| 🌐 Python \| 📅 2026-07-02                           | A command-line productivity tool powered by AI large language models like GPT-4.                                                                     |
...
|                               [warp](https://github.com/warpdotdev/Warp) ⭐ 64,612 \| 🐛 5,114 \| 🌐 Rust \| 📅 2026-08-29                               | Warp is a modern, Rust-based terminal with AI built in so you and your team can build great software, faster.                                        |
...
|                     [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) ⭐ 13,094 \| 🐛 150 \| 🌐 Shell \| 📅 2024-07-26                    | A curated list of Terminal frameworks, plugins, and resources for CLI lovers.                                                                        |
